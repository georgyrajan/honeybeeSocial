...
<form onsubmit="void(0)" style="border:1px solid #ccc" method="get">
  <div class="container">
  <table id="baview" class="display" style="width:100%">
        <thead>
            <tr>
                <th>Code</th>
                <th>Version</th>
        ...
        <tbody>
        <c:forEach var="detail" items="${reportDetails.listResult}">
            <tr>
                <td>${detail.code}</td>
                <td>${detail.version}</td>
                <td>${detail.countDTO.inprogress}</td>
                <td>${detail.countDTO.completed}</td>
            </tr>
       </c:forEach>
          </tbody>
    </table>
