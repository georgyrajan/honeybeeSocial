...
<form onsubmit="void(0)" style="border:1px solid #ccc" method="get">
  <div class="container">
  <table id="adminview" class="display" style="width:100%">
        <thead>
            <tr>
                <th>Name</th>
                <th>Code</th>
        ...
        <tbody>
        <c:forEach var="urlDetail" items="${urlDetails}">
            <tr>
                <td>${urlDetail.name}</td>
                <td>${urlDetail.code}</td>
                <td>${urlDetail.description}</td>
                <td>${urlDetail.url}</td>
            </tr>
       </c:forEach>
          </tbody>
